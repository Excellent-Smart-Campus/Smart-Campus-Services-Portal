...
maxStartTime.setHours(18, 0, 0, 0)

export const modelBookingRoom = Schema.Model({
    room: NumberType().isRequired(errorMessages.required),
    ...
    startTime: DateType()
        .isRequired(errorMessages.required)
        .min(minStartTime, errorMessages.time.start)
        .max(maxStartTime, errorMessages.time.start)
    ,
    endTime: DateType()
        .isRequired(errorMessages.required)
        .addRule((value, data) => {
